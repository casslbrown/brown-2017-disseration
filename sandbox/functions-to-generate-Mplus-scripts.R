...
mplus_generator_bivariate <- function(
 ...
 # Values for testing and development
  ...
  # path_prototype     = "./manipulation/estimation/ALT-11-plus-fixed-soc-on-cog-aec.inp"
  ...
  (assigning_a_to_timepoints <- paste0("a","_",wave_set_modeled,"@",time_slope))
  ...
  (assigning_b_to_timepoints <- paste0("b","_",wave_set_modeled,"@",time_slope))
