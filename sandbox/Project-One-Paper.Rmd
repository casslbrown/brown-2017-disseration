...
However, when covariates were added to the model the significant cross-lagged relations were no longer significant indicating that these relations were accounted for by the included covariates. 
