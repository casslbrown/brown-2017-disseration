...
variables_static <- c("id", "male", "age_baseline", "birthyr_rand", "birthmo_rand", "race_rand", "hispanic_rand", "cohort", "raedyrs","raedegrm","spdem_2004", "spdem_2006",
...
d_wide <- d_wide %>% 
  dplyr::mutate(
    agec_2004 = age_baseline-62,
    agec_2006 = age_baseline-62,
    agec_2008 = age_baseline-62,
    agec_2010 = age_baseline-62,
    agec_2012 = age_baseline-62,
    agec_2014 = age_baseline-62
  )
...
# prepared for Mplus
write.table(d_wide, "./data-unshared/derived/ct-wide-dataset.dat", row.names=F, col.names=F)
write(names(d_wide), "./data-unshared/derived/ct-wide-variable-names.txt", sep=" ")
