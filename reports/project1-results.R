...
wrectotd_loneliness_summary<- extractModelSummaries("./output/bivariate-models-nodem-65plus/wrectotd-score_loneliness_3")
wrectotd_loneliness_summary["CM"] <- 3
wrectotd_loneliness_summary[1:3, "CM"] <- "-"
wrectotd_loneliness_summary[10:11, "CM"] <- "9"
wrectotd_loneliness_summary[12, "CM"] <- "9"
wrectotd_loneliness_summary[13, "CM"] <- "17"
...
wrectd_lonely_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectotd-score_loneliness_3/m12_nocov_wrectotd_score_loneliness_3.out")
...
wrectotd_social_contact_summary<- extractModelSummaries("./output/bivariate-models-nodem-65plus/wrectotd-social_contact_total")
wrectotd_social_contact_summary["CM"] <- 3
wrectotd_social_contact_summary[1:3, "CM"] <- "-"
wrectotd_social_contact_summary[10:11, "CM"] <- "9"
wrectotd_social_contact_summary[12, "CM"] <- "9"
wrectotd_social_contact_summary[13, "CM"] <- "9"
wrectotd_social_contact_summary[14, "CM"] <- "13"
wrectotd_social_contact_summary[15, "CM"] <- "13"
wrectotd_social_contact_summary[16, "CM"] <- "13"
...
# model 12 the ALT model with no time specific correlations and fixed autoregressions is the final model
wrectd_sc_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectotd-social_contact_total/m15_nocov_wrectotd_social_contact_total.out")
...
# TASKS TO COMPLETE: RENAME THE FILES SO THE TABLE PRODUCED CAN BE PUT IN MANUSCRIPT
wrectoti_social_network_summary<- extractModelSummaries("./output/bivariate-models-nodem-65plus/wrectoti-socialnetwork_total")
wrectoti_social_network_summary["CM"] <- 3
wrectoti_social_network_summary[1:3, "CM"] <- "-"
wrectoti_social_network_summary[10:11, "CM"] <- "9"
wrectoti_social_network_summary[12, "CM"] <- "9"
...
wrecti_sn_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectoti-socialnetwork_total/m11_nocov_wrectoti_socialnetwork_total.out")
...
wrecti_sn_fullALT_parameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectoti-socialnetwork_total/m03_nocov_wrectoti_socialnetwork_total.out")

wrecti_sn_fullALT_parameters <- as.data.frame(wrecti_sn_fullALT_parameters[[1]]) 

# # create a new column `parameter` with the two name columns paramHeader and param collapsed together
wrecti_sn_fullALT_parameters$parameter <- paste(wrecti_sn_fullALT_parameters$paramHeader,wrecti_sn_fullALT_parameters$param)

# select relevant parameters and then save file.
# this allows the parameters to be accessible to the R markdown file for writing results. 
wrecti_sn_fullALT <- wrecti_sn_fullALT_parameters %>% dplyr::select(parameter, est, se, pval)
wrecti_sn_fullALT$pval <- sprintf("%.3f", wrecti_sn_fullALT$pval)
wrecti_sn_fullALT$est <- sprintf("%.3f", wrecti_sn_fullALT$est)
write.csv(wrecti_sn_fullALT, file = "./output/bivariate-models-nodem-65plus/wrecti_social_network_fullmodel_parameters.csv")
bivariateALT_parameter_extraction_function(wrecti_sn_fullALT)


#---- immediate-word-recall-social-support-summary --------------------------
# TASKS TO COMPLETE: RENAME THE FILES SO THE TABLE PRODUCED CAN BE PUT IN MANUSCRIPT
wrectoti_social_support_summary<- extractModelSummaries("./output/bivariate-models-nodem-65plus/wrectoti-social_support_mean")
wrectoti_social_support_summary["CM"] <- 3
wrectoti_social_support_summary[1:3, "CM"] <- "-"
wrectoti_social_support_summary[10:11, "CM"] <- "9"
wrectoti_social_support_summary[12, "CM"] <- "9"
...
# model 11 the ALT model with no time specific correlations and fixed autoregressions for immediate word recall is the most supported model 
wrecti_socsup_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectoti-social_support_mean/m16_nocov_wrectoti_social_support_mean.out")
...
# TASKS TO COMPLETE: RENAME THE FILES SO THE TABLE PRODUCED CAN BE PUT IN MANUSCRIPT
wrectoti_social_contact_summary<- extractModelSummaries("./output/bivariate-models-nodem-65plus/wrectoti-social_contact_total")
wrectoti_social_contact_summary["CM"] <- 3
wrectoti_social_contact_summary[1:3, "CM"] <- "-"
wrectoti_social_contact_summary[10:11, "CM"] <- "9"
wrectoti_social_contact_summary[12, "CM"] <- "9"
wrectoti_social_contact_summary[13, "CM"] <- "9"
wrectoti_social_contact_summary[14, "CM"] <- "13"
wrectoti_social_contact_summary[15, "CM"] <- "13"
wrectoti_social_contact_summary[16, "CM"] <- "13"
...
# model 11 the ALT model with no time specific correlations and fixed autoregressions for immediate word recall is the most supported model 
wrecti_social_contact_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectoti-social_contact_total/m13_nocov_wrectoti_social_contact_total.out")
...
wrectoti_loneliness_summary["CM"] <- 3
wrectoti_loneliness_summary[1:3, "CM"] <- "-"
wrectoti_loneliness_summary[10:11, "CM"] <- "9"
wrectoti_loneliness_summary[12, "CM"] <- "9"
...
# model 11 the ALT model with no time specific correlations and fixed autoregressions for immediate word recall is the most supported model 
wrecti_loneliness_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/wrectoti-score_loneliness_3/m15_nocov_wrectoti_score_loneliness_3.out")
...
write.csv(wrecti_loneliness_ATL, file = "./output/bivariate-models-nodem-65plus/wrecti_loneliness_model_parameters.csv")
...
# model 11 the ALT model with no time specific correlations and fixed autoregressions for immediate word recall is the most supported model 
mentalstatus_sc_ATLparameters <- extractModelParameters("./output/bivariate-models-nodem-65plus/mentalstatus_tot-social_contact_total/m12_nocov_mentalstatus_tot_social_contact_total.out")
...
# TASKS TO COMPLETE: RENAME THE FILES SO THE TABLE PRODUCED CAN BE PUT IN MANUSCRIPT
mental_loneliness<- extractModelSummaries("./output/bivariate-models-nodem-65plus/mentalstatus_tot-score_loneliness_3")
...
write.csv(mentalstatus_lone_ATL, file = "./output/bivariate-models-nodem-65plus/mentalstatus_loneliness_model_parameters.csv")
...
# Extract the fit indices of relevant models
loneliness_series4 <- extractModelSummaries("./output/univariate-models-nodem-65plus/score_loneliness_3")
...
#----loneliness-----
loneliness_ATLparameters <- extractModelParameters("./output/univariate-models-nodem-65plus/score_loneliness_3/u08_nocov_score_loneliness_3.out")
